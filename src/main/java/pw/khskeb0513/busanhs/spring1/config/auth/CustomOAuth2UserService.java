...
import pw.khskeb0513.busanhs.spring1.config.auth.dto.OAuthAttributes;
import pw.khskeb0513.busanhs.spring1.config.auth.dto.SessionUser;
import pw.khskeb0513.busanhs.spring1.domain.user.User;
import pw.khskeb0513.busanhs.spring1.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private User saveOrUpdate(OAuthAttributes oAuthAttributes) {
        User user = userRepository.findByEmail(oAuthAttributes.getEmail())
                .map(v -> v.update(oAuthAttributes.getName(), oAuthAttributes.getPicture()))
